...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Reads the previous PDFs with pages CSV URL.')
    parser.add_argument('csv_uri', type=str, help='The URL or Path to the CSV with the argument list for ExtractDataFromPdfDashboardGSheetWrapper')
    ...
    task_args_df['positive-breakdown-page'] = task_args_df['positive-breakdown-page'] - 1
    task_list = []
    ...
    luigi_run_result = luigi.build(task_list, local_scheduler=True, detailed_summary=True)
