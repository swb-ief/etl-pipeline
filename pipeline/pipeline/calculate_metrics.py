...
def calculate_metrics_input(input_file="input/city_stats.csv", start_date="2020-04-20", hospitalizations="output/percentages_for_hospitalizations.csv", output="output/city_metrics.csv", header=True):
